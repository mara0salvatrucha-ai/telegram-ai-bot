...
--------------
🤖 ИИ КОМАНДЫ:
  .aiconfig help      - Справка по настройкам ИИ
  .aiconfig status    - Статус ИИ
  .aiconfig on        - Включить ИИ глобально
  .aiconfig off       - Выключить ИИ глобально
  .aiconfig auto on   - Включить авто-ответ всем
  .aiconfig auto off  - Выключить авто-ответ
  .aiconfig show      - Показать текущий конфиг
  .aiconfig export    - Экспорт конфига в файл
  .aiconfig reset     - Сброс конфига
  .aiconfig personality <текст> - Задать личность ИИ
  .neiro <запрос>     - Быстрый запрос к ИИ
  .aiclear            - Очистить историю чата

🎯 ИИ ПО ЧАТАМ:
  .aistop             - Выключить ИИ в ЭТОМ чате
  .aiston             - Включить ИИ в ЭТОМ чате
  .aichat status      - Статус ИИ по чатам
  .aichat groups off  - Выключить ИИ во всех группах
  .aichat groups on   - Включить ИИ в группах
  .aichat private off - Выключить ИИ в личных
  .aichat private on  - Включить ИИ в личных

🔇 ЗАГЛУШКА:
  .замолчи            - Заглушить пользователя (ответом на сообщение)
  .говори             - Разглушить пользователя (ответом на сообщение)
  .говори <id>        - Разглушить по ID
  .список             - Список заглушенных

💾 СОХРАНЕНИЕ:
  .saver              - Настройки сохранения сообщений
  .deleted            - Посмотреть удаленные сообщения

🎬 АНИМАЦИИ:
  .anim               - Управление анимациями
